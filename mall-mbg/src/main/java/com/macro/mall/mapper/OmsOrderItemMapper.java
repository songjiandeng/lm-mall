...
public interface OmsOrderItemMapper {
    ...
    List<OmsOrderItem> selectByExampleWithBLOBs(OmsOrderItemExample example);
    ...
    int updateByExampleWithBLOBs(@Param("row") OmsOrderItem row, @Param("example") OmsOrderItemExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(OmsOrderItem row);
